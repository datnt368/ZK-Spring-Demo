package vn.test.zkoss.service.impl;
...
public class CarServiceImpl implements CarService {
    ...
    public CarServiceImpl() {
        int id = 1;
        this.carList = Stream.of(
                new Car(id++, "Primera", "Nissan",
                        ...
                        "~./resources/img/car1.png",
                        23320),
                new Car(id++, "Cefiro", "Nissan",
                        ...
                        "~./resources/img/car2.png",
                        38165),
                new Car(id++, "Camry", "Toyota",
                        ...
                        "~./resources/img/car3.png",
                        24170),
                new Car(id++, "Century", "Toyota",
                        ...
                        "~./resources/img/car4.png",
                        28730),
                new Car(id++, "Sigma", "Mitsubishi",
                        ...
                        "~./resources/img/car5.png",
                        54120),
                new Car(id++, "Challenger", "Mitsubishi",
                        ...
                        "~./resources/img/car6.png",
                        58750),
                new Car(id++, "Civic", "Honda",
                        ...
                        "~./resources/img/car1.png",
                        17479),
                new Car(id++, "New Beetle", "Volkswagen",
    ...
    public List<Car> search(String keyword) {
        if (keyword == null || keyword.isEmpty()) {
            ...
            return this.carList.stream()
                    .filter(c -> c.getModel().toLowerCase().contains(keyword.toLowerCase()) || c.getMake().toLowerCase().contains(keyword.toLowerCase()))
                    .collect(Collectors.toList());
        }
    }
